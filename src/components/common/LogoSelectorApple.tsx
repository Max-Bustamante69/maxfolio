  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-expanded={open}
        aria-haspopup="menu"
        className={`press inline-flex items-center gap-2 h-8 md:h-9 pl-1 pr-2.5 md:pl-1.5 md:pr-3 rounded-full ${isDark ? 'hover:bg-white/10' : 'hover:bg-black/5'} compact-touch`}
      >
