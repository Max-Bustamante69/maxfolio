...
function useActiveSection(ids: string[]) {
  ...
  // The nav is 44px below md, 56px from md up (more breathing room) — the observer's top margin has
  // to track that or "active" flips a beat early/late right at the md boundary.
  const [navHeight, setNavHeight] = useState(() => (typeof window !== 'undefined' && window.matchMedia('(min-width: 768px)').matches ? 56 : 44))
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className={`theme-apple min-h-screen font-sf ${bg} transition-colors duration-300 [overflow-x:clip]`} role="document">
        ...
        {/* Nav — 44px on phones, 56px from md up for more breathing room, frosted */}
        <nav
          className={`fixed top-0 inset-x-0 z-40 h-11 md:h-14 ${isDark ? 'bg-black/70' : 'bg-white/70'} backdrop-blur-xl border-b ${isDark ? 'border-white/10' : 'border-black/5'}`}
        ...
        >
          <div className="max-w-5xl mx-auto h-full px-4 md:px-6 flex items-center justify-between gap-3">
            ...
            <div className="hidden md:flex items-center gap-6 md:gap-8 text-xs md:text-[13px]">
              {nav.map(([href, label]) => {
                ...
                return (
                  <a
                    ...
                    className={`relative inline-flex items-center h-11 md:h-14 transition-colors duration-150 ${on ? blue : `${muted} hover:${blue}`}`}
                  >
                    {label}
                    {on && (
                      <m.span
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <button
                ...
                className={`press compact-touch w-8 h-8 md:w-9 md:h-9 rounded-full flex items-center justify-center ${isDark ? 'bg-white/10 text-white' : 'bg-black/5 text-[#1d1d1f]'}`}
              >
              ...
              <button
                ...
                className="press compact-touch hidden sm:inline-flex h-8 md:h-9 items-center rounded-full bg-apple-blue px-3.5 md:px-4 text-xs font-medium text-white hover:bg-apple-blueHover"
              >
                {c.hero.ctaContact}
              </button>
              <MobileMenuApple
        ...
        <main id="main-content" className="pt-11 md:pt-14">
          {/* Hero — typographic */}
          <section id="hero" className="px-4 pt-16 md:pt-24 pb-10 md:pb-14 text-center scroll-mt-20 md:scroll-mt-[92px]" aria-labelledby="hero-heading">
          ...
          {/* The inner Experience.tsx also renders its own id="experience" (shared with every theme,
              ...
              projects/contact. */}
          <section id="experience" className={`px-4 py-14 md:py-20 scroll-mt-20 md:scroll-mt-[92px] ${surface}`}>
            <div className="max-w-5xl mx-auto">
          ...
          <section className="px-4 py-14 md:py-20 scroll-mt-20 md:scroll-mt-[92px]">
            <div className="max-w-5xl mx-auto">
          ...
          <section id="shopify" className="px-4 py-14 md:py-20 scroll-mt-20 md:scroll-mt-[92px]">
            <div className="max-w-5xl mx-auto">
              <Suspense fallback={<Pending />}>
          ...
          <section id="gallery" className={`px-4 py-14 md:py-20 scroll-mt-20 md:scroll-mt-[92px] ${surface}`}>
            <div className="max-w-5xl mx-auto">
              <Suspense fallback={<Pending />}>
          ...
          <section className="px-4 py-12 md:py-16 scroll-mt-20 md:scroll-mt-[92px]">
            <div className="max-w-5xl mx-auto">
              <Suspense fallback={<Pending />}>
          ...
          <section id="projects" className="px-4 py-14 md:py-20 scroll-mt-20 md:scroll-mt-[92px]">
            <div className="max-w-5xl mx-auto">
              <Suspense fallback={<Pending />}>
          ...
          <section id="skills" className={`px-4 py-14 md:py-20 scroll-mt-20 md:scroll-mt-[92px] ${surface}`}>
            <div className="max-w-5xl mx-auto">
              <Suspense fallback={<Pending />}>
          ...
          <section id="contact" className={`relative overflow-hidden px-4 py-24 md:py-32 scroll-mt-20 md:scroll-mt-[92px] ${surface}`}>
            <img
          ...
          {/* Explore */}
          <section id="explore" className="px-4 py-20 scroll-mt-20 md:scroll-mt-[92px]">
            <div className="max-w-5xl mx-auto">
