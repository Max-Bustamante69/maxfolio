...
import { LuxuryPreview, BrutalistPreview, ApplePreview, NeoPreview, PersonaPreview, SkylinePreview } from '../components/previews'

export type DesignId = 'apple' | 'luxury' | 'brutalist' | 'neo' | 'persona' | 'skyline'
